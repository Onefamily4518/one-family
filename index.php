...
switch ($page) {
   ...
   case 'oauth':
    ...
    case 'homeFeed':
        ...
        break;
    case 'singleFeed':
        include('sources/singleFeed.php');
        break;     
    case 'post_api':
    ...
    case 'get_familyMember_api':
        ...
        break;
    case 'updateProfile':
        include('sources/updateprofileapi.php');
        break;
    ...
    case 'userProfile':
        ...
        break;
    case 'postDelete':
        include('sources/postDelete.php');
        break;
    case 'searchUser':
        include('sources/searchUser.php');
        break;
    case 'postReport':
        include('sources/reportPost.php');
        break;
    case 'supportedMediaList':
        include('sources/supportedMediaList.php');
        break;
    case 'updateProfileImage': 
        include('sources/updateProfileImage.php');
        break;

    case 'updatePost': 
        include('sources/updatePost.php');
        break;

        case 'insertStory': 
            include('sources/insertStory.php');
            break;
            
        case 'deleteStory': 
            include('sources/deleteStory.php');
            break;
        case 'showStory': 
            include('sources/showStory.php');
            break;
            case 'viewStory': 
                include('sources/viewStory.php');
                break;

                case 'treeStructure': 
                    include('sources/treeStructure.php');
                    break;

                    case 'member':
                        include('sources/createMember.php');
                        break;
    
    // route['onefamilyTraining'] = onefamily/training
}
